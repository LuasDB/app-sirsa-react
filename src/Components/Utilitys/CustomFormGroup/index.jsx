      ...
      <div>
        ...
        {type === 'select' ? (
          <select
            ...
            value={value}
            onChange={onChange}
            className={`w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-gray-800 dark:text-white ${error ? 'border-red-500 ring-1 ring-red-500' : ''}`}
          >
